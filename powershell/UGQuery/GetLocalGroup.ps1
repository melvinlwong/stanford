Function Get-LocalGroup  {
  ...
  #[String[]]$Computername =  (Get-ADComputer -Filter 'Enabled -eq "True"' -Properties Name -SearchBase "OU=Servers,OU=SESI,DC=lbre-sesi,DC=stanford,DC=edu" | Select -ExpandProperty Name),
  [String[]]$Computername =  (Get-Content "C:\Scripts\UGQuery\member_servers.txt"),
